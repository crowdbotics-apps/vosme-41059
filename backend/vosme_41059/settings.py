"""
Django settings for vosme_41059 project.
...
WSGI_APPLICATION = 'vosme_41059.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vosme_41059 API",
    "DESCRIPTION": "API documentation for vosme_41059 App",
    "VERSION": "v1",
}
